...
namespace Jira.IntegrationTests
{
    public static class EnvironmentVariables
    {
        ...
        public static string JiraServerUrl => GetValue("JiraServerUrl");
        public static string JiraUsername => GetValue("JiraUsername");
        public static string JiraPassword => GetValue("JiraPassword");
        public static string ProjectKey => GetValue("ProjectKey");
        public static string IssueFilter => GetValue("IssueFilter");
        public static string IssueNamePrefix => GetValue("IssueNamePrefix");
        public static string IssueCleanFilter => GetValue("IssueCleanFilter");
    }
}
